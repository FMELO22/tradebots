"""
A simple script that tries to buy an amount of RPC with ARS in small chunks
config.json requires the value api_key like
{"api_key": "...."}
Example buy 1000 RPC pay max 180 pesos per USD doing 100 RPC chunks:
python ...py config.json 1000 180 100
"""
import json
import os
import sys
...
def run(API_KEY, amount_to_buy, limit, chunk):
    ...
    print("WOOHOO DONE COMPRE: %s RPC" % total_bought)
